...
def dga(date: datetime, version: str, num_domains: int):
    # this will actually be locale dependent, so be prepared for + or - on week shifts
    # on week shifts
...
if __name__ == "__main__":
    ...
    with open("domains.txt", "w") as file:
        for domain in dga(date=date, version=args.version, num_domains=args.num_domains):
            file.write(domain + "\n")
