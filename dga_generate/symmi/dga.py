...
seed_const = 42
days_period = 16
nr_of_domains = 20000  # 修改为需要生成的域名数量
third_lvl_min_len = 8
...
if __name__ == "__main__":
    ...
    # 获取生成的域名列表
    domains = dga(seed, ".ddns.net", nr_of_domains)
    
    # 将生成的域名写入 domains.txt 文件
    with open("domains.txt", "w") as file:
        for domain in domains:
            file.write(domain + "\n")

    print(f"{nr_of_domains} domains have been written to 'domains.txt'")
